...
std::map<std::string, MyCompiler::BackEnd::SymbolTable::stentry>::iterator stit;
MyCompiler::BackEnd::SymbolTable::stentry* tempEnt = new MyCompiler::BackEnd::SymbolTable::stentry;

//function to visit statment nodes
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTStatementNode* s)
{
	//test to see whether statement is a simple expression
	isExpression = true;
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTIfNode* in)
{
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTWhileNode* w)
{
	//casting of first child to expression node
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTWriteNode* w)
{
	//mark that statement is not a simple expression
	isExpression = false;
	//visit first child
	w->children.at(0)->accept(this);
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTReturnNode* r)
{
	//visit child node
	r->children.at(0)->accept(this);
	MyCompiler::BackEnd::ASTExprNode* postAns = dynamic_cast<MyCompiler::BackEnd::ASTExprNode*>(r->children.at(0));
	tempValue = postAns->exprVal;
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTBlock* b)
{
	//create a new scope
	st.createScope();
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTVariableDeclNode* v)
{
	//mark that statement is not a simple expression
	isExpression = false;
	...
	else
	{
		...
		//create new/update ans entry in symbol table
		if ((stit = st.scopeStack.top().find("ans")) == st.scopeStack.top().end())
		{
			st.insertInScope("ans", *st2);
		}
		else
		{
			stit->second = *st2;
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTAssignmentNode* a)
{
	//mark that statement is not a simple expression
	isExpression = false;
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTRelationalOp* r)
{
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTExprNode* e)
{
		...
		if (i % 2 == 0 && max > i + 2)
		{
			...
			else
			{
				...
				case 1:
					...
					{
						std::cout << "Semantic Error: Invalid type for relational operation" << std::endl;throw std::exception("Type Error");
						throw std::exception("Type Error");
					}
	...
	//store value as 'ans' in symbol table
	if (isExpression)
	{
		isExpression = false;
		tempEnt->func = false;
		tempEnt->vv = tempValue;
		//create new/update ans entry in symbol table
		if ((stit = st.scopeStack.top().find("ans")) == st.scopeStack.top().end())
		{
			st.insertInScope("ans", *tempEnt);
		}
		else
		{
			stit->second = *tempEnt;
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTAdditiveOp* a)
{
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTSimpleExpression* se)
{
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTMultiplicativeOp* a)
{
	//assign respective value according to operator type
	if (a->stringVal.compare("*") == 0)
	{
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTTermNode* t)
{
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTFactorNode* f)
{
	//visit child node
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTUnaryNode* u)
{
	//visit first child
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTSubExprNode* s)
{
	//visit child node
	s->children.at(0)->accept(this);
}
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTFunctionCall* f)
{
	st.createScope();
	isExpression = false;
	...
	if (!st.inScope(l->stringVal))
	{
		...
		throw std::exception("Undefined Function Error");
	}
	else
	{
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTIdentifierNode* i)
{
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTLiteralNode* l)
{
	//visit child node
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTBoolLiteral* b)
{
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTIntegerLiteral* i)
{
	//store copy of literal type and value
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTRealLiteral* r)
{
	//store copy of literal type and value
...
void MyCompiler::BackEnd::InterpreterREPL::visit(MyCompiler::BackEnd::ASTStringLiteral* s)
{
	//store copy of literal type and value
